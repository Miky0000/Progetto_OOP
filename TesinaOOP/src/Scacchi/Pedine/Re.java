        ...
        this.color = color;
        {
            try {
                if (color.equalsIgnoreCase("black") )
                    this.img = ImageIO.read(Objects.requireNonNull(Re.class.getResource("/Immagini/KingNero.png")));
                else
                    this.img= ImageIO.read(Objects.requireNonNull(Re.class.getResource("/Immagini/KingBianco.png")));
