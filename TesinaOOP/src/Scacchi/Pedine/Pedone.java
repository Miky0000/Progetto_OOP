...
public class Pedone extends PezzoScacchi {
    ...
    public Pedone(String color) {
        this.color = color;
        {
            try {
                if(this.color=="white") {
                    this.img = ImageIO.read(Objects.requireNonNull(Pedone.class.getResource("/Immagini/PedoneBianco.png")));
                }
                else {
                    this.img = ImageIO.read(Objects.requireNonNull(Pedone.class.getResource("/Immagini/PedoneNero.png")));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
