...
public class PedinaDama extends PezzoDama {
    ...
    public PedinaDama(String color) {
        ...
        try {
            if (color.equals("black"))
                this.img= ImageIO.read(Objects.requireNonNull(PedinaDama.class.getResource("/Immagini/DamaNera.png")));
            else
                this.img= ImageIO.read(Objects.requireNonNull(PedinaDama.class.getResource("/Immagini/DamaBianca.png")));
    ...
    public ArrayList<Integer> getMoves (Map<Integer, Damabotton> griglia, Integer I) {
        ...
        if (this.color.equals("black")){
            ...
            int tmpx=x-1;
            int tmpy=y+1;
            if (x >= 1 && tmpy <= 7 && griglia.get(tmpx + 8 * tmpy).getPezzo() == null)
                out.add(tmpx+tmpy*8);
